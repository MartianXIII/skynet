"use strict";
    ...
    function quitGame () {
        if (simonClick.length < 5) {
            alert("Your high score was " + (highScore) + ". Dont quit your day job bro?");
        } else if (simonClick.length < 7) {
            alert("Your high score was " + (highScore) + ". Keep practicing ^^, .");
        } else if (simonClick.length < 10) {
            alert("Your high score was " + (highScore) + ". Nice!");
        } else if (simonClick.length < 15) {
            alert("Your high score was " + (highScore) + ". Good Shit.");
        } else {
            alert("Your high score was " + (highScore) + ". Wait, are you cheating?");
        }
